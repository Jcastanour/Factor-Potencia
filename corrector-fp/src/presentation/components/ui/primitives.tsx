...
export function Section({ className, children, tone = "default", ...rest }: SectionProps) {
  return (
    <section
      {...rest}
      className={cn(
...
export function SectionInner({ className, children }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
...
export function Eyebrow({ children, className }: React.HTMLAttributes<HTMLSpanElement>) {
  return (
...
export function SectionHeading({
  ...
  return (
    ...
    >
      ...
      {body && (
        <p className="mt-6 text-lg leading-relaxed text-[var(--fg-muted)] sm:text-xl">{body}</p>
      )}
    </header>
  );
}
...
export function Monolabel({ children, className }: React.HTMLAttributes<HTMLSpanElement>) {
  return (
    <span
      className={cn(
