...
/**
 * Modelo 3D conceptual del corrector FP.
 * Lighting manual (sin HDR externo) para que renderice siempre.
 */
...
export function DeviceScene({
  ...
  return (
    ...
    >
      ...
      >
        {/* Lighting manual — no depende de HDR externo */}
        ...
        {/* Piso sutil para sombras/referencia */}
        <mesh
