export const meta = {
  ...
  description:
    "Proyecto Integrado de Ingeniería — Facultad de Minas, Universidad Nacional de Colombia. Corrector automático de factor de potencia de bajo costo, plug-and-play, basado en ESP32.",
};
...
export const hero = {
  ...
  sub:
    "Los motores, compresores y neveras de tu negocio mueven corriente que no hace trabajo. La red te cobra por ella. La ley te penaliza si no la corriges. Este proyecto la devuelve al sistema de forma automática.",
  cta: "Ver cómo funciona",
  meta: [
    { label: "Factor de Potencia mínimo (CREG 101-035/2024)", value: "0.90" },
...
export const problem = {
  ...
  body:
    "En las panaderías, talleres y lavanderías de Medellín los motores y compresores crean un tipo de consumo invisible — energía reactiva — que inflama la factura cada mes. El dueño del negocio rara vez sabe por qué.",
  stats: [
...
export const wherePerfiles = [
  ...
  },
  {
    ...
    dolor:
      "«El compresor prende y baja la luz. La factura del mes es una lotería».",
  },
  {
    id: "carpinteria",
    titulo: "Carpintería",
  ...
  },
  {
    ...
    dolor:
      "«Trabajo por kilos. Si me suben la luz 200 mil al mes, quedo en rojo».",
  },
];
...
export const electrical = {
  ...
  body:
    "La corriente que entra al negocio tiene dos componentes. Una hace trabajo — mueve el motor, enfría la nevera, calienta el horno. La otra solo sostiene el campo magnético de esos equipos y regresa sin producir nada. Se llama energía reactiva. Tú la pagas igual.",
};
...
export const device = {
  ...
  body:
    "Se instala entre tu medidor y tu tablero. Mide voltaje y corriente en tiempo real, calcula cuánta reactiva estás moviendo, y conecta condensadores para compensarla. Todo sin intervención.",
  specs: [
  ...
  modes: [
    {
      ...
      body: "Autoverificación de sensores, relés y memoria al arrancar.",
    },
    {
      key: "AUTOCAL",
      title: "Autocalibración",
      body: "Ajuste de ganancias de ZMPT101B y SCT-013-030 contra referencia conocida.",
    },
    {
      key: "DIAG",
      title: "Diagnóstico 24 h",
      body: "Perfil de carga del comercio por ventanas horarias.",
    },
    {
      key: "ACTIVE",
      title: "Control activo",
      body: "Histéresis 0.88 / 0.97 · objetivo 0.95 · retardo 30 s entre conmutaciones.",
    },
  ],
};
...
export const demo = {
  ...
  body:
    "Este es un modelo simplificado con los umbrales reales del firmware. El tiempo entre conmutaciones se aceleró para que lo notes.",
};
...
export const state = {
  ...
  body:
    "La página que ves presenta la visión técnica y narrativa del proyecto antes del armado físico final. Los valores, umbrales y cálculos son los del firmware real que alimentará el ESP32.",
};

export const team = {
  eyebrow: "Equipo",
  headline: "Proyecto Integrado de Ingeniería.",
  context: "Instituto de Educación en Ingeniería · Facultad de Minas · UNAL sede Medellín",
